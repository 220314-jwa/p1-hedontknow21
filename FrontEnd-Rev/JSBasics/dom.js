 ...
 */
var elementsWithClassRev = document.getElementById('rev');
...
function changeHelloSpan() {
    ...
    //     ${message}
    // </strong>`;
    helloSpan.innerHTML = `<strong>${ message } regular html text {message}</strong>`;
    //helloSpan.innerHTML = '<strong>' + message + '!</strong>';
}

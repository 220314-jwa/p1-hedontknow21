 ...
 * able to do when interacting with a database (CRUD methods - create, read, update and delete) but leaves
 ...
 * C- Create, insert (SQL), Post(HTTP)
 * R- Read, select (SQL), Get (HTTP)
 * U- Update, update (SQL), Put (HTTP)
 * D- Delete, delete (SQL), Delete (HTTP)
 */

...
public class User {
	...
	private List<StoryPitch> pitches;
	...
	public List<StoryPitch> getPitches() {
		return pitches;
	}

	public void setPitches(List<StoryPitch> pitches) {
	...
	public String toString() {
		return "StoryPitch [id=" + id +", username=" + userName + ", password=" + passWord + ", firstname="
